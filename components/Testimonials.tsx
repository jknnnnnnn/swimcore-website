    ...
    <section id="opinie" className="scroll-mt-16 bg-ink py-24 sm:py-28 lg:py-36">
      <Container>
        <SectionHeading
          ...
          centered
        />
        <div className="mx-auto mt-9 flex max-w-xl items-center gap-4 rounded-[1.4rem] border border-line bg-card p-5 shadow-none sm:p-6">
          <span className="grid h-12 w-12 shrink-0 place-items-center rounded-xl bg-orange text-ink shadow-glow">
