      ...
      <Container className="relative">
        <div className="grid items-center gap-14 lg:grid-cols-[1.02fr_0.98fr] lg:gap-16">
          ...
          <div className="relative isolate mx-auto w-full max-w-[590px] lg:mx-0">
            ...
            <div className="relative aspect-[0.93] overflow-hidden rounded-[2.25rem] border border-line bg-card shadow-soft sm:aspect-[1.08] lg:aspect-[0.95]">
              <Image
            ...
            <div className="absolute right-4 top-4 rounded-2xl border border-line bg-card/90 px-4 py-3 text-white shadow-card backdrop-blur-xl sm:-right-4 sm:top-8">
