        ...
        <div className="grid items-center gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:gap-16">
          <div className="relative mx-auto w-full max-w-[480px]">
            <div className="relative aspect-[0.82] overflow-hidden rounded-[2rem] border border-white/10 bg-surface shadow-soft">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-ink/90 via-purple/10 to-transparent" />
          ...
          <div>
            ...
            <div className="mt-7 grid gap-3 sm:grid-cols-2">
              {achievements.map((achievement) => (
                <div
                  key={achievement}
                  className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.05] px-4 py-3 text-xs font-extrabold leading-5 text-white shadow-card backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-cyan/45 hover:bg-white/[0.08]"
                >
                  <span className="grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-gradient-to-br from-purple to-cyan text-white">
